...
export function StickyCheckoutBar({
  ...
  const handleCheckout = async () => {
    ...
    // Haptic feedback: checkout proceed (80ms)
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        WebkitBoxShadow: '0 -4px 12px -2px rgba(0, 0, 0, 0.15)',
      }}
    >
      {/* Inner highlight (tactile press effect) */}
      <div
      ...
      <div className="h-14 px-4 flex items-center justify-between gap-4 max-w-7xl mx-auto w-full relative z-10">
        ...
        {/* Center: Optional Info (Can be extended) */}
        <div className="flex-1 text-center" />

        {/* Right: Total Price & Checkout Button */}
        <div className="flex items-center gap-4">
          ...
          <motion.button
            ...
            className={`h-14 px-6 rounded-[10px] font-semibold text-sm whitespace-nowrap transition-all duration-150 flex-shrink-0 ${
              isCheckoutDisabled
            ...
            style={{
              boxShadow: !isCheckoutDisabled
                ...
                : 'none',
              WebkitBoxShadow: !isCheckoutDisabled
                ? '0 4px 6px -1px rgba(0, 0, 0, 0.15)'
                : 'none',
            }}
          >
